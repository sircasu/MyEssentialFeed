...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_feedView_hasTitle() {
        ...
        XCTAssertNotEqual(localizedKey, localizedTitle, "Missing localizedd string for key: \(localizedKey)")
...
//        sut.loadViewIfNeeded() // viewDidLoad
    ...
    func test_feedImageView_cancelImageloadingWhenNotVisibleAnymore() {
        ...
        XCTAssertEqual(loader.cancelledImageURLs, [image0.url], "Expected one cancelled image URL request once is not visible anymore")
        
        sut.simulateFeedImageViewNotVisible(at: 1)
        XCTAssertEqual(loader.cancelledImageURLs, [image0.url, image1.url], "Expected two cancelled imaege URL requests ince second image is also not visible anymore")
    }
    ...
    func test_feedImageViewRetryButton_isVisibleOnInvalidImageData() {
        ...
        XCTAssertEqual(view?.isShowingRetryAction, true, "Expected retry action once image loading completeswith invalid image data")
    }
    ...
    func test_feedImageViewRetryAction_retriesImageLoad() {
        ...
        loader.completeImageLoadingWithError(at: 1)
        XCTAssertEqual(loader.loadedImageURLs, [image0.url, image1.url], "Expcted only two images URL requests before retry action")
